...
define("MINIAUDIOPLAYER_VERSION", "1.9.3");
...
function miniAudioPlayer_player_head()
{
    ...
    function initializeMiniAudioPlayer(){
         ...
         jQuery("a' . ($miniAudioPlayer_active_all != 'true' ? '.mb_map' : '') . '[href*=\'.mp3\'] ,a' . ($miniAudioPlayer_active_all != 'true' ? '.mb_map' : '') . '[href*=\'.m4a\']")' . miniAudioPlayer_getExcluded() . 'mb_miniPlayer(miniAudioPlayer_defaults);
    }
