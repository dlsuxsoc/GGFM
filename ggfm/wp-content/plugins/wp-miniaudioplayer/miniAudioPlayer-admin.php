...
add_action('admin_init', 'miniAudioPlayer_register_settings');
add_action('admin_menu', 'miniAudioPlayer_add_option_page');

function miniAudioPlayer_add_option_page()
{
	// hook in the options page function
	add_options_page('miniAudioPlayer', 'mb.miniAudioPlayer', 'manage_options', __FILE__, 'miniAudioPlayer_options_page');
}

function miniAudioPlayer_register_settings()
{
...
add_action('admin_enqueue_scripts', 'miniaudioplayer_load_admin_script');
function miniaudioplayer_load_admin_script($hook)
{
...
{ // Output the options page
  ...
  <div class="wrap" style="width:800px">
    ...
    <div class="highlight fade" style="padding: 10px; margin: 0">
      ...
      <form action="http://pupunzi.us6.list-manage2.com/subscribe/post?u=4346dc9633&amp;id=91a005172f" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank"
            novalidate>
    ...
    <form id="optionsForm" method="post" action="options.php">
      ...
      <p><?php _e('You can always overwrite any single player settings by selecting the audio link in the post editor and clicking on the mb.miniAudioPlayer button on the top of the TinyMCE editor toolbar', 'wp-miniaudioplayer'); ?>
        .</p>
      ...
      <table class="form-table">
        ...
        <tr valign="top">
          ...
          <td>
            ...
            <hr>
            <input id="miniAudioPlayer_replaceDefault_show_title" type="checkbox" name="miniAudioPlayer_replaceDefault_show_title"
                   value="true" <?php if (get_option('miniAudioPlayer_replaceDefault_show_title') == "true") {
				echo ' checked="checked"';
			} ?>/>
        ...
        <tr valign="top">
          ...
          <td>
            <input type="checkbox" name="miniAudioPlayer_getMetadata"
                   value="true" <?php if (get_option('miniAudioPlayer_getMetadata') == "true") {
				echo ' checked="checked"';
			} ?>/>
        ...
        <tr valign="top">
          ...
          <td>
            ...
            <br>
            <p><b><a class="button" href="http://pupunzi.com/mb.components/mb.miniAudioPlayer/demo/skinMaker.html" target="_blank"
                     style="text-transform: uppercase; border-color: #3A98FB"><?php _e('Open the Skin Maker Tool', 'mbMiniAudioPlayer') ?></a></b></p>
            <br>
            ...
            <p style="margin-top: 20px"><?php _e('<b>If you want to modify this CSS</b> you should save and upload it on the skinMaker tool;<br> once changed, save it back and upload it here again', 'mbMiniAudioPlayer') ?>
              .</p>
            <script>
            ...
            <p style="text-align: right">
              <button class="button"
                      onclick="jQuery.file.save('customSkinCss', 'css','<?php echo get_option('miniAudioPlayer_custom_skin_name') ?>'); return false "><?php _e("Save this skin as file", 'mbMiniAudioPlayer') ?></button>
            </p>
        ...
        <tr valign="top">
          ...
          <td>
            ...
            <p><?php _e('The size is relative to the inner part of the player; if you want you can set the with as percentage, in that case the player will be adaptive for different screen resolutions, included mobile devices', 'wp-miniaudioplayer'); ?>
              .</p>
          </td>
        </tr>
        ...
        <tr valign="top">
          ...
          <td>
            ...
            <p>
              <i><?php _e('You can either manually add this class to the audio links you want to exclude or select the link and check the "Don’t render" checkbox of the popup window in the editor page', 'wp-miniaudioplayer'); ?>
                .</i></p>
        ...
        <tr valign="top">
          ...
          <td>
            <input type="checkbox" name="miniAudioPlayer_download" onclick="map_manageSecurity(this)"
                   value="true" <?php if (get_option('miniAudioPlayer_download') == "true") {
				echo ' checked="checked"';
			} ?>/>
            <script>
				function map_manageSecurity(el)
				{
					let security = jQuery('[name=miniAudioPlayer_download_security]')
